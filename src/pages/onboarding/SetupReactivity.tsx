...
const OPTIONS = [
  "It barely reacts — most movement feels fine",
  "Lightly reactive — some movements are uncomfortable",
  "Reactive — many movements cause pain",
  "Very reactive — even small movements hurt",
];

export default function SetupReactivity() {
  ...
  const handleContinue = () => {
    ...
    try {
      ...
      data.reactivity = selected;
      localStorage.setItem("vinys_setup", JSON.stringify(data));
    } catch {}
    navigate("/onboarding/setup-pain-duration");
  };
    ...
    <div style={{ minHeight: "100vh", background: "#F5F0E6", display: "flex", flexDirection: "column" }}>
      ...
      <main style={{ flex: 1, display: "flex", justifyContent: "center", padding: "32px 20px 80px" }}>
        <div style={{ maxWidth: "640px", width: "100%" }}>
          ...
          >
            First — how reactive is your back right now?
          </h1>

          {/* Framing line */}
          <p style={{ fontSize: "16px", color: "rgba(25,23,21,0.65)", marginBottom: "24px", lineHeight: 1.5 }}>
            This helps us choose the right intensity for your first session. There's no wrong answer.
          </p>
